...
import 'package:provider_with_model/Provider/Provider.dart';
import 'package:provider_with_model/UI/AddProduct.dart';
import 'package:provider_with_model/UI/ProductDetail.dart';
        ...
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(builder: (_) => ProductDetails(id)),
              ...
              Provider.of<MyProvider>(context, listen: false).delete(id));
        },
        child: Column(
          children: [
            SizedBox(height: 5),
